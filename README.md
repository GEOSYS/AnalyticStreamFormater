...
Use of this project requires valids credentials from the <geosys/>. If you need to get trial access, please register [here](https://earthdailyagro.com/geosys-api/#get-started).
